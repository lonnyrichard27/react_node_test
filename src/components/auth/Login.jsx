 ...
 * validation, error handling, and state management. Implements API-based
 * authentication with the backend server.
 * 
 * Features:
 * - Calls actual server API for authentication
...
const Login = () => {
   ...
   * Calls the server API for user authentication
   * 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        email: email.trim(),
        password: password,
        ...(role && { role }) // Include role if specified
      };
